...
int main()
{
    ...
    const uint64_t valueSize1 = 2048*2*2*2;
    ...
    const uint64_t cycleNum1_ = 1024 * 64;
    const uint64_t valueSize1_ = 512;
    ...
    const uint64_t cycleNum3 = 1024 * 128*2;
    const uint64_t valueSize3 = 8192;
    std::string insertValue3(valueSize3, 's');
    std::cout << "Value Size: " << std::to_string(valueSize3) << std::endl;

    std::cout << "Test for PUTs ..." << std::endl;
